...
public class GUI extends javax.swing.JFrame {
  ...
  public java.io.File getSelectedCompressLocation() {
    SaveFileChooser saveFileChooser = new SaveFileChooser();
    saveFileChooser.setFileSelectionMode(JFileChooser.FILES_ONLY);

    FileFilter filter = new FileNameExtensionFilter("Archiva Fájl", "arc");
    saveFileChooser.setAcceptAllFileFilterUsed(false);
    saveFileChooser.setFileFilter(filter);

    saveFileChooser.setDialogTitle("Kérem válassza ki hova mentődjön a tömörített fájl.");
  ...
  public void addFileImportHandler(GUICompressController.FileImportHandler fih) {
    toCompressTable.setTransferHandler(fih);
    toCompressTable.setDropMode(DropMode.INSERT_ROWS);
    toCompressTable.setFillsViewportHeight(true);
  }

  public JTable getDeCompressTable() {
    return this.deCompressTable;
  }
  ...
  private void initComponents() {
    ...
    addElementToCompressBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/icons/package-variant-plus(1).png"))); // NOI18N
    ...
    removeElementToCompressBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/icons/package-variant-minus.png"))); // NOI18N
    ...
    compressBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/icons/package-variant-closed.png"))); // NOI18N
    ...
    chooseCompressedFileBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/icons/package-variant-closed.png"))); // NOI18N
    ...
    deCompressBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/icons/package-variant.png"))); // NOI18N
    ...
    jLabel2.setText("Archiva");

    jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/icons/main-icon.png"))); // NOI18N
